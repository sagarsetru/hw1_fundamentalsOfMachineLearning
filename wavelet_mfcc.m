function [ CC, FBE ] = wavelet_mfcc( speech, fs, Tw, Ts, alpha, R, M, N, L )
% MFCC Mel frequency cepstral coefficient feature extraction, with Morlet
% wavelet transform
%
%   Author: Kamil Wojcicki and Mochi Liu
    ...
    MAG = findWavelets(speech,H,K,fs); 
